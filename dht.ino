/*
*==========================================================================================*
|                             Created by Eka Yulianto . 2025                               |
|                       AZURE LIB : Azure SDK for C by Microsoft Corporation               |
*==========================================================================================*
*/
...
/*
  Function to set-up current time from SNTP
*/
...
/*
  Function to init connection to IoT Hub service
*/
...
static char* getTelemetryPayload()
{
  ...
  return (char*)telemetry_payload.c_str();
}
